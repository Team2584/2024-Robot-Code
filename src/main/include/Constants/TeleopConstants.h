...
inline constexpr auto DRIVE_SLEW_RATE  = 4_mps; // Maximum change in drive percentage per second (i.e '2' means the drive will go from fully forward to fully reverse in 1 second)
inline constexpr auto SPIN_SLEW_RATE  = 4_mps; // Not actually meters per second
