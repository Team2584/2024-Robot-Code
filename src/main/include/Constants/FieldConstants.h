...
inline const Translation3d BLUE_SPEAKER_AIM_POSITION = {0.05_m, 5.54_m, 2.75_m}; 
inline const Translation3d RED_SPEAKER_POSITION = {16.579342_m, 5.547867999999999_m, 2.75_m}; 
inline const Translation3d RED_SPEAKER_AIM_POSITION = {16.52_m, 5.547867999999999_m, 2.75_m}; 
